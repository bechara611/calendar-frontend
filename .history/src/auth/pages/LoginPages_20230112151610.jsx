...
const {onInputChange:onInputChangeRegister,registerEmail,registerName,registerPassword,registerPassword2,formState:estadoRegister,isFormValid:isFormValidRegister,registerEmailValid, registerPasswordValid,registerPassword2Valid,registerNameValid}= useForm(registerFields,formValidationsRegister)
                ...
                <div className="col-md-6 login-form-2">
                    ...
                    <form onSubmit={onSubmitRegister}>
                        <div className="form-group mb-2">
                            <input
                                type="text"
                                className={`form-control ${(registerNameValid && isSubmited ) ? 'is-invalid':'' }`}
                                placeholder="Name"
                                name='registerName'
                                value={registerName}
                        ...
                        <div className="form-group mb-2">
                            <input
                                type="password"
                                className={`form-control ${(registerPasswordValid && isSubmited ) ? 'is-invalid':'' }`}
                                placeholder="Password" 
                        ...
                        <div className="form-group mb-2">
                            <input
                                type="password"
                                className={`form-control ${(registerPassword2Valid && isSubmited ) ? 'is-invalid':'' }`}
