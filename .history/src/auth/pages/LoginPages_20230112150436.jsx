...
const {onInputChange:onInputChangeRegister,registerEmail,registerName,registerPassword,registerPassword2,formState:estadoRegister,isFormValid:isFormValidRegister,registerEmailValid, registerPasswordValid,registerPassword2Valid}= useForm(registerFields,formValidationsRegister)
