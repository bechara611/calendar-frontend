...
const {onInputChange:onInputChangeRegister,registerEmail,registerName,registerPassword,registerPassword2,formState:estadoRegister,isFormValid:isFormValidRegister,registerEmailValid}= useForm(registerFields,formValidationsRegister)
...
const onSubmitRegister=(e)=>{
    ...
    console.log({isFormValidRegister})
    console.log({registerEmailValid})
}
