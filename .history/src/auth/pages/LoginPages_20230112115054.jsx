...
const {onInputChange:onInputChangeRegister,registerEmail,registerName,registerPassword,registerPassword2,formState:estadoRegister,isFormValid:isFormValidRegister}= useForm(registerFields,formValidationsRegister)
